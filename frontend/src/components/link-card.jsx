...
const LinkCard = ({ url, fetchUrls }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-5 border bg-black/30 p-4 rounded-lg shadow-md hover:shadow-red-600/40 transition duration-300">
      <img
        src={url?.qr}
      ...
      >
        ...
        <span className="text-sm text-red-400 truncate hover:underline cursor-pointer">
          https://shrt.ly/{url?.custom_url ? url?.custom_url : url.short_url}
        </span>
